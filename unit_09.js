...
function f11() {
    ...
    document.querySelector('.out-11').appendChild(newElem);
}
...
function f12() {
    ...
    document.querySelector('.out-12').appendChild(newElem);
}
...
function f13() {
    ...
    document.querySelector('.out-13').appendChild(newElem);
}
...
function f14() {
    ...
    document.querySelector('.out-14').prepend(newElem);
}
...
function f15() {
    ...
    document.querySelector('.out-15').before(newElem);
}
...
function f16() {
    ...
    document.querySelector('.out-16').after(newElem);
}
...
function f17() {
    ...
    document.querySelector('.out-17').replaceWith(newElem);
}
...
function f18() {
    ...
    let newAtr = p.getAttribute('data-b');
    console.log(newAtr);
    document.querySelector('.out-18').innerHTML = newAtr;
}
...
let prg = document.querySelectorAll('.p-19');

function f19() {
    let out = '';
    for (let i = 0; i < prg.length; i++) {
        out += prg[i].getAttribute('data-b') + ' ';
    }
